...
type EnumNum<T extends any[]> = T extends [...infer F, infer O] ? { readonly [key in Capitalize<Extract<T[number], O>>]: F['length'] } & EnumNum<F> : {};

type Enum<T extends readonly string[], N extends boolean = false> = N extends false ? {
