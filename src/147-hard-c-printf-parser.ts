...
type ParsePrintFormat<S extends string> = S extends `${string}%${infer F}${infer E}` ? (F extends keyof ControlsMap ? [ControlsMap[F], ...ParsePrintFormat<E>] : ParsePrintFormat<E>) : [];
