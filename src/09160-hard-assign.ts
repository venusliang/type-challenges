...
type AssignSignle<T, U, K extends keyof any = keyof T | keyof U> = {
  [K1 in K]: K1 extends keyof U ? U[K1] : K1 extends keyof T ? T[K1] : never;
};
...
type Assign<T extends Record<string, unknown>, U extends any[]> = U extends [
  ...
  ? Assign<R extends object ? AssignSignle<T, R> : T, R2>
  : T;
